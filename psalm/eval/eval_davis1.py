...
from psalm.train.train_datasets import interactive_dataset
...
class DataArguments:
    ...
    json_path: str = '/nfs-data1/zhangkunquan/SIOR/test1.json'
    ...
    region_mask_type: Optional[str] = field(default="point_visual_prompt_mask")
...
class DAVIS_Dataset(interactive_dataset):
    def __getitem__(self, idx):
        data = self.data[idx]
        image_file = data['image1_info']['image']
        image_folder = self.data_args.region_cross_image_folder


        data_dict = {}
        data_dict['file_name'] = os.path.join(image_folder, image_file)
        data_dict['height'] = data['image1_info']['height']
        data_dict['width'] = data['image1_info']['width']
        data_dict['image_id'] = data['image1_info']['img_id']
        data_dict['annotations'] = data['annotations1']
        data_dict['vp_annotations'] = data['annotations']
        data_dict['vp_image'] = os.path.join(image_folder,data['image_info']['image'])
