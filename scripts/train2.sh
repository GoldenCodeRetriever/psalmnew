...
#RRSIS-D_SIOR_SIORCross_10
deepspeed --include localhost:6,7 --master_port 29504  psalm/train/train.py \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path "/home/zhangkunquan/code/PSALM/PSALM/phi-1_5_dev" \
    --version "llava_phi" \
    --region_cross_json_path "/nfs-data1/zhangkunquan/SIOR/interactive_train.json" \
    --region_cross_image_folder "/nfs-data1/zhangkunquan/SIOR/images" \
    --region_json_path "/nfs-data1/zhangkunquan/SIOR/train_category/category_14.json" \
    --region_image_folder "/nfs-data1/zhangkunquan/SIOR/images" \
    --panoptic_json_path "/nfs-data1/zhangkunquan/psalm-data/coco" \
    --referring_json_path "/nfs-data1/zhangkunquan/RRSIS-D_split/referring/train/referring.json" \
    --referring_image_folder "/nfs-data1/zhangkunquan/RRSIS-D_split/referring/train/JPEGImages" \
    ...
    --fp16 True \
    --output_dir ./output/checkpoint/ship \
    --num_train_epochs 10 \
